...
class WelcomePage : OnboardingPageFragment(R.layout.content_onboarding_welcome) {
    ...
    private fun renderNewOrReturningUsers() {
        binding.ctas!!.returningUserCta.visibility = VISIBLE
        binding.ctas!!.returningUserCta.setOnClickListener { event(WelcomePageView.Event.OnReturningUserClicked) }
        ctaText = getString(R.string.returningUsersOnboardingDaxText)
        binding.ctas!!.hiddenTextCta.text = ctaText.html(requireContext())
        binding.ctas!!.primaryCta.text = getString(R.string.returningUsersNewUserButton)
    }

    private fun renterDefaultOnboarding() {
        binding.ctas!!.returningUserCta.visibility = GONE
        ctaText = getString(R.string.onboardingDaxText)
        binding.ctas!!.hiddenTextCta.text = ctaText.html(requireContext())
        binding.ctas!!.primaryCta.text = getString(R.string.onboardingLetsDoItButton)
    }
